...
\begin{frame}[plain,fragile]
    \begin{tikzpicture}[remember picture,overlay]
      \node[minimum width=\paperwidth, minimum height=\paperheight, anchor=north west,remember picture,overlay] (a) {
...
\section{Basic array calculations}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    \node at (current page.north west) {
      \begin{tikzpicture}[y=-1cm,remember picture,overlay]
        \draw [very thick, black!30!red] (4.8,2.6) ellipse (0.75 cm and 0.25 cm);
        \draw [-{Latex[scale=1.5]}, very thick, black!30!red] (2,4.1) -- (4.2,2.7);
      \end{tikzpicture}
    };
  \end{tikzpicture}
\end{frame}
...
byte[] openBytes(int no,
  ...
  \begin{tikzpicture}[remember picture,overlay]
    \node at (current page.north west) {
      \begin{tikzpicture}[y=-1cm,remember picture,overlay]
        \draw [very thick, black!30!red] (5.15,2.95) ellipse (1.1 cm and 0.3 cm);
        \draw [-{Latex[scale=1.5]}, very thick, black!30!red] (2,4.1) -- (4.15,3.05);
      \end{tikzpicture}
    };
  \end{tikzpicture}
\end{frame}
...
byte[] openBytes(int no,
  ...
  \begin{tikzpicture}[remember picture,overlay]
    \node at (current page.north west) {
      \begin{tikzpicture}[y=-1cm,remember picture,overlay]
        \draw [very thick, black!30!red] (5.4,3.32) ellipse (1.3 cm and 0.25 cm);
        \draw [very thick, black!30!red] (8.05,3.32) ellipse (1.3 cm and 0.25 cm);
        \draw [-{Latex[scale=1.5]}, very thick, black!30!red] (3.5,4.1) -- (4.25,3.4);
        \draw [-{Latex[scale=1.5]}, very thick, black!30!red] (6.25,4.1) -- (6.95,3.4);
      \end{tikzpicture}
    };
  \end{tikzpicture}
\end{frame}
